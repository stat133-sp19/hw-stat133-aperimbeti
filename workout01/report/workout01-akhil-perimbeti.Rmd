---
title: "Workout01-akhil-perimbeti"
...
```{r echo = FALSE}
library(knitr)
knitr::include_graphics('/Users/akhilperimbeti/Desktop/stat133/workout01/images/gsw-shot-charts.png')
```
...
```{r echo = FALSE}
read.csv("/Users/akhilperimbeti/Desktop/stat133/workout01/data/percent_of_2PT.csv")
```
...
```{r echo = FALSE}
read.csv("/Users/akhilperimbeti/Desktop/stat133/workout01/data/percent_of_3PT.csv")
```
...
```{r echo = FALSE}
read.csv("/Users/akhilperimbeti/Desktop/stat133/workout01/data/total_overall_percent.csv")
```
